...
In this blog, specific to the problem here is **10000 transactions per second (10k TPS)**. 
...
- **Problem from client to web server layer:**
  ...
  ![](../images/post-1/load-balancing.png)
